...
import com.example.thesis.controller.ContactsAdapter;
...
public class Contacts extends AppCompatActivity {
    ...
    private void initRecyclerContacts(){
        ...
        ContactsAdapter contactsAdapter = new ContactsAdapter(peopleList, this);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(Contacts.this,"Pobieram dane z bazy",Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://thesis-server9.herokuapp.com/contacts";
